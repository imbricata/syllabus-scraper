...
DEGREES = {
    ...
    "matematicas-computacion": ("350", "478"),
    "informatica": ("218", "570"),
    "ade": ("204", "565"),
    "derecho": ("350", "374"),
    "economia": ("350", "375"),
    ...
    "turismo": ("350", "393"),
    "aeroespacial": ("251", "421"),
    "datos": ("350", "566"),
    "telecomunicacion": ("252", "568"),
    "tecnologias-industriales": ("256", "418"),
    "biomedica": ("257", "522"),
    "ingenieria-fisica": ("363", "434"),
    "inteligencia-artificial": ("506", "555"),
    "finanzas-contabilidad": ("201", "520"),
    "empresa-tecnologia": ("351", "486"),
    "estudios-internacionales": ("305", "504"),
}
